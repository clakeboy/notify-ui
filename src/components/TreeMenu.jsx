            ...
            <div className={this.getClasses()}>
                <ul className='ck-tree-menu-elm' ref={c=>this.main_dom=c}>
                    {this.state.data.map((item)=>{
                        if (item.step) {
                            return <li className='divider'>{item.text}</li>
                        }
                        if (item.children) {
                            return (
                                <li className='parent'>
                                    <a href='javascript://' onClick={this.openHandler}>
                                    ...
                                    <ul className="sub-menu">
                                        {item.children.map((child)=>{
                                            return (
                                                <li><a href="javascript://" onClick={this.clickHandler(child)}>{child.text}</a></li>
                                            )
                                        })}
                                    </ul>
                                </li>
                            ...
                            return (
                                <li>
                                    <a href='javascript://' onClick={this.clickHandler(item)}>
                                        <Icon className='icon' icon={item.icon}/>
                                        <span>{item.text}</span>
                                    </a>
                                </li>
